...
$(function () {
    ...
    var time = setInterval(function () {
        $('.phone-list li').click(function () {
            ...
            console.log($(this).closest('ul').prev().children().eq(0).children().eq(index));
            $(this).closest('ul').prev().children().eq(0).children().eq(index).addClass('show-phone').siblings().removeClass('show-phone');
