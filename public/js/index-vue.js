...
$(function () {
    new Vue({
        ...
        methods: {
            ...
            posImg: function posImg(index) {
                if (index == 0) {
                    ...
                    try {
                        for (var _iterator = $('.phone-box')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            item = _step.value;
                    ...
                    try {
                        for (var _iterator2 = $('.select-phone-box')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            var item = _step2.value;
                            this.addId(item);
                            this.i++;
                        }
                        this.i = 5;
                        for (var _iterator2 = $('.phone-box')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            var item = _step2.value;
                            this.addId(item);
                            this.i++;
                        }
            ...
            showTxt: function showTxt(index) {
            ...
            hideTxt: function hideTxt(index) {
            ...
            //进入购物车
            intoCart: function intoCart(index) {
                var id = $('.phone-box').eq(index).attr('imgId');
                sessionStorage.setItem("id", id);
            },
            offCart: function offCart(index) {
                var id = $('.select-phone-box').eq(index).attr('imgId');
                sessionStorage.setItem("id", id);
            }
        },
        mounted: function mounted() {
            ...
            this.$http.get('/shopData').then(function (res) {
                _this.shopHot = res.data;
            });
        },
